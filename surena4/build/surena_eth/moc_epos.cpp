...
#include "../../src/surena_eth/src/epos.h"
...
void Epos::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Epos::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Epos::NewDataReady)) {
                *result = 0;
            }
        }
        {
            typedef void (Epos::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Epos::Dummy)) {
                *result = 1;
            }
        }
        {
            typedef void (Epos::*_t)(QList<int16_t> , QList<int32_t> , QList<int32_t> , QList<uint16_t> , QList<float> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Epos::FeedBackReceived)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Epos::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Epos.data,
      qt_meta_data_Epos,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Epos::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Epos.stringdata0))
        return static_cast<void*>(const_cast< Epos*>(this));
