...
message(STATUS "surena_eth: 0 messages, 3 services")
...
get_filename_component(_filename "/home/milad/software/humanoid/surena4/src/surena_eth/srv/reset_node.srv" NAME_WE)
add_custom_target(_surena_eth_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "surena_eth" "/home/milad/software/humanoid/surena4/src/surena_eth/srv/reset_node.srv" ""
)

get_filename_component(_filename "/home/milad/software/humanoid/surena4/src/surena_eth/srv/active_csp.srv" NAME_WE)
add_custom_target(_surena_eth_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "surena_eth" "/home/milad/software/humanoid/surena4/src/surena_eth/srv/active_csp.srv" ""
)

get_filename_component(_filename "/home/milad/software/humanoid/surena4/src/surena_eth/srv/home.srv" NAME_WE)
add_custom_target(_surena_eth_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "surena_eth" "/home/milad/software/humanoid/surena4/src/surena_eth/srv/home.srv" ""
)
...
_generate_srv_cpp(surena_eth
  "/home/milad/software/humanoid/surena4/src/surena_eth/srv/reset_node.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/surena_eth
)
_generate_srv_cpp(surena_eth
  "/home/milad/software/humanoid/surena4/src/surena_eth/srv/active_csp.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/surena_eth
)
_generate_srv_cpp(surena_eth
  "/home/milad/software/humanoid/surena4/src/surena_eth/srv/home.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/surena_eth
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/surena_eth)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/surena_eth\")")
  # install generated code
  install(
