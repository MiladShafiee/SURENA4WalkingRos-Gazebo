...
#include "../../src/surena_eth/src/tcphandler.h"
...
QT_MOC_LITERAL(5, 44, 9), // "ReadyRead"
QT_MOC_LITERAL(6, 54, 12) // "Disconnected"

    },
    "TcpHandler\0NewDataReceived\0\0Dummy\0"
    "Connected\0ReadyRead\0Disconnected"
};
...
void TcpHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpHandler::NewDataReceived)) {
                *result = 0;
            }
        }
        {
            typedef void (TcpHandler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpHandler::Dummy)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void TcpHandler::NewDataReceived(QByteArray _t1)
{
