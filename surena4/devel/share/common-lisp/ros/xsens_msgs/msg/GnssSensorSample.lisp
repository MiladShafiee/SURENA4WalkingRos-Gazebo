...
(cl:defmethod cl:initialize-instance :after ((m <GnssSensorSample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GnssSensorSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<GnssSensorSample> is deprecated: use xsens_msgs-msg:GnssSensorSample instead.")))
