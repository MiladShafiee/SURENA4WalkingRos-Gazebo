...
(cl:defmethod cl:initialize-instance :after ((m <BaroSensorSample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BaroSensorSample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<BaroSensorSample> is deprecated: use xsens_msgs-msg:BaroSensorSample instead.")))
