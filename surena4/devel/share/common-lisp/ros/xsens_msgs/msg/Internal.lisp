...
(cl:defclass <Internal> (roslisp-msg-protocol:ros-message)
  ((imu
    :reader imu
    :initarg :imu
    :type xsens_msgs-msg:ImuSensorSample
    :initform (cl:make-instance 'xsens_msgs-msg:ImuSensorSample))
   (mag
    :reader mag
    :initarg :mag
   ...
   (baro
    :reader baro
    :initarg :baro
    :type xsens_msgs-msg:BaroSensorSample
    :initform (cl:make-instance 'xsens_msgs-msg:BaroSensorSample))
   (gnss
    :reader gnss
    :initarg :gnss
    :type xsens_msgs-msg:GnssSensorSample
    :initform (cl:make-instance 'xsens_msgs-msg:GnssSensorSample)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Internal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Internal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xsens_msgs-msg:<Internal> is deprecated: use xsens_msgs-msg:Internal instead.")))

(cl:ensure-generic-function 'imu-val :lambda-list '(m))
(cl:defmethod imu-val ((m <Internal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:imu-val is deprecated.  Use xsens_msgs-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'mag-val :lambda-list '(m))
(cl:defmethod mag-val ((m <Internal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:mag-val is deprecated.  Use xsens_msgs-msg:mag instead.")
  (mag m))

(cl:ensure-generic-function 'baro-val :lambda-list '(m))
(cl:defmethod baro-val ((m <Internal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:baro-val is deprecated.  Use xsens_msgs-msg:baro instead.")
  (baro m))

(cl:ensure-generic-function 'gnss-val :lambda-list '(m))
(cl:defmethod gnss-val ((m <Internal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xsens_msgs-msg:gnss-val is deprecated.  Use xsens_msgs-msg:gnss instead.")
  (gnss m))
