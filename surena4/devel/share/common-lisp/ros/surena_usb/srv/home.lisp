...
(cl:defmethod cl:initialize-instance :after ((m <home-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_usb-srv:<home-request> is deprecated: use surena_usb-srv:home-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <home-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'home-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name surena_usb-srv:<home-response> is deprecated: use surena_usb-srv:home-response instead.")))
